<template>
  <div class="hello">
    <el-button  type="text" class="add-member" @click="dialogFormVisible = true">{{$t('add_member')}}</el-button>
     <el-table align="left" :data="members" height="400" style="width: 100%">
          <el-table-column prop="username" :label="$t('username')" width="230">
          </el-table-column>
          <el-table-column prop="addtime" :label="$t('add_time')" width="200">
          </el-table-column>
          <el-table-column prop="member_group" :label="$t('authority')">
          </el-table-column>

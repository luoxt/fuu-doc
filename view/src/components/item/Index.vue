    ...
    <el-container class="container-narrow">
      <el-row class="masthead">
          <div class="logo-title ">
              <h2 class="muted" style="color:#2393d6"><img src="static/logo/b_64.png" style="width:50px;height:50px;margin-bottom:-10px;" alt="">FUU-DOC</h2>
          </div>
          
          <div class="header-btn-group pull-right">
            <el-button type="text"  @click="feedback"></el-button>
            &nbsp;&nbsp;&nbsp;
...
export default {
  ...
  methods:{
    get_item_list(){
        ...
        var user_info = that.$cookies.get('user_info')
        if(user_info){
            params.append('token', user_info.token)
        }

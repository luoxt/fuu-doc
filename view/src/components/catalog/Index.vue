  ...
  <div class="hello">
    ...
    <el-container>
      ...
      <el-button type="text" class="goback-btn" @click="goback">{{$t('goback')}}</el-button>
       <el-table align="left" :data="catalogs" height="400" :row-class-name="tableRowClassName" style="width: 100%">
            <el-table-column prop="cat_name" :label="$t('cat_name')" width="230">
            </el-table-column>
            <el-table-column prop="addtime" :label="$t('add_time')" width="160">
            </el-table-column>
            <el-table-column
              prop="s_number"
              :label="$t('s_number')">
        ...
        <el-form >
            ...
            <el-form-item :label="$t('parent_cat_name')+' : '" >
              <el-select v-model="MyForm.parent_cat_id" :placeholder="$t('none')">
                  <el-option v-for="item in catalogs_level_2" :key="item.cat_id" :label="item.cat_name" :value="item.cat_id">
                  </el-option>
                </el-select>
            </el-form-item>
